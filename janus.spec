...
%prep
%setup -q -n janus-0.7.0
cd %{_builddir}/janus-0.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637783641
...
cp %{_builddir}/janus-0.7.0/LICENSE %{buildroot}/usr/share/package-licenses/janus/840d2e227459bbd5c33423550411f4dac2758ee5
